...
import { closeBackdrop, openBackdrop, setAddProductModal } from '../redux/slice/appSlice';
        ...
        <Box sx={style}>
           ...
           <div>
            ...
            <div className='flex justify-center'>
                <Button type='submit' size='small' sx={{textTransform:"none"}} variant='outlined' color='secondary'> Ürün Ekle </Button>
            </div>
            </form>
           </div>
        </Box>
